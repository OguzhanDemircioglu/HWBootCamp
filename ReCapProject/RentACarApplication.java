package com.etiya.RentACarSpring.RentACar;
...
import com.etiya.RentACarSpring.RentACar.core.utilities.result.ErrorDataResult;
...
public class RentACarApplication {
    ...
    public Docket api() { 
        return new Docket(DocumentationType.SWAGGER_2)  
          .select()                                  
          .apis(RequestHandlerSelectors.basePackage("com.etiya.RentACarSpring.RentACar"))                                     
          .build();                                           
    }
